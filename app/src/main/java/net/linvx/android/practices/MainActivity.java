...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_display_image = (Button) this.findViewById(R.id.button_display_image);
        button_display_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppUtils.startActivity(MainActivity.this, DisplayImageActivity.class);
            }
        });

        Button button_scan_barcode = (Button) this.findViewById(R.id.button_scan_barcode);
        button_scan_barcode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppUtils.startActivity(MainActivity.this, ScanBarcodeActivity.class);
            }
        });
